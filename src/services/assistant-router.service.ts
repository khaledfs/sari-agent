...
const routerSystemPrompt = [
  ...
  '- "cart": the message is about adding/updating/removing a cart item, placing an order, looking up or comparing a specific catalog product by name/SKU, or reordering a past/habitual purchase.',
  ...
  'If uncertain, choose "cart" only when the message clearly names a product to act on; otherwise choose "advice".',
 ...
 */
export async function classifyAssistantMessageRoute(message: string): Promise<AssistantMessageRoute> {
  try {
